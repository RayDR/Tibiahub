  ...
  const loadHunts = async () => {
    ...
    try {
      ...
      if (filters.level_min)
        filterParams.level_min = parseInt(filters.level_min);
      if (filters.level_max)
        filterParams.level_max = parseInt(filters.level_max);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFilters({ ...filters, level_min: e.target.value })
                }
                placeholder="e.g. 50"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFilters({ ...filters, level_max: e.target.value })
                }
                placeholder="e.g. 150"
                className="w-full bg-surface-base border border-line rounded p-2 text-content-primary text-sm"
              />
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setFilters({ ...filters, vocation: e.target.value })
                }
                className="w-full bg-surface-base border border-line rounded p-2 text-content-primary text-sm"
              >
                ...
                {hunt.exp_per_hour && (
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-success">
                      {formatNumber(hunt.exp_per_hour)}
                    </span>
                  </div>
                )}
                {hunt.profit_per_hour && (
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-primary">
                      {formatNumber(hunt.profit_per_hour)}k
                    </span>
                  </div>
                )}
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        level_min: parseInt(e.target.value),
                      })
                    }
                    className="w-full bg-surface-base border border-line rounded p-2 text-content-primary"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        level_max: parseInt(e.target.value),
                      })
                    }
                    className="w-full bg-surface-base border border-line rounded p-2 text-content-primary"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, vocation: e.target.value })
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        exp_per_hour: parseInt(e.target.value),
                      })
                    }
                    className="w-full bg-surface-base border border-line rounded p-2 text-content-primary"
                  />
                ...
                <div className="col-span-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        profit_per_hour: parseInt(e.target.value),
                      })
                    }
                    className="w-full bg-surface-base border border-line rounded p-2 text-content-primary"
                  />
                ...
                <div className="col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, creatures: e.target.value })
                    }
