...
export default function NotificationsPage() {
  ...
  const load = async () => { setLoading(true); setError(false); try { setItems(await notificationApi.list()); } catch { setError(true); } finally { setLoading(false); } };
  useEffect(() => { void load(); }, []);
