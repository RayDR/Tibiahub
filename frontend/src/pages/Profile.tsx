...
export default function Profile() {
  ...
  const save = async (event: FormEvent) => {
    ...
    if (formData.new_password && !isValidPassword(formData.new_password)) { toast.error(t('profile.messages.passwordPolicy')); return; }
    setSaving(true);
    try {
