    ...
    return (
        <div className="relative">
            <button
                ...
                className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm text-content-muted transition-all duration-300 hover:bg-surface-inverse/5 hover:text-primary group"
            >
            ...
            {isOpen && (
                <>
                    ...
                    />
                    <div className="absolute right-0 z-20 mt-2 w-64 overflow-hidden rounded-lg border border-line bg-surface shadow-xl backdrop-blur-sm">
                        {themes.map((themeItem) => (
                            ...
                            >
                                ...
                                <div className="text-left flex-1">
                                    ...
                                    <div className="text-xs text-content-muted">{themeItem.description}</div>
                                </div>
                                {theme === themeItem.id && (
