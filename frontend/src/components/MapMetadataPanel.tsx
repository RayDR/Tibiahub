    ...
    const load = async () => {
      try {
        ...
        if (floor != null) {
          ...
          } catch { /* Keep map metadata visible without a floor asset. */ }
        }
      } catch {
