...
export default function LanguageSwitcher() {
    ...
    const languages = [
        { code: 'en', name: 'English', flag: '🇺🇸', emoji: 'US' },
        { code: 'es', name: 'Español', flag: '🇲🇽', emoji: 'MX' },
    ];
    ...
    return (
        <div className="relative">
            ...
            >
                ...
                <span className="hidden md:inline text-xs text-slate-400">{currentLang.emoji}</span>
            </button>
                    ...
                    <div className="absolute right-0 mt-2 w-40 bg-slate-900 border border-slate-700 rounded-lg shadow-xl z-20 overflow-hidden backdrop-blur-sm">
                        {languages.map((lang) => (
                            ...
                            >
                                ...
                                <span className="text-xs font-medium">{lang.emoji}</span>
                            </button>
                        ))}
                    </div>
                </>
