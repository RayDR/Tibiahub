        ...
        resources: {
            en: {
                translation: {
                    ...
                    "map": { "title": "Map", "searchLabel": "Search Map", "searchPlaceholder": "Hunt, creature, quest, NPC or location", "loading": "Loading local map data…", "noResults": "No local results match this search.", "noBaseMap": "No locally imported world floor is available yet.", "mapped": "Mapped locally", "knowledgeOnly": "Knowledge only", "noGeometry": "TibiaHub has related knowledge, but no reliable geometry for this entry.", "coordinates": "Coordinates: {{x}}, {{y}}, floor {{z}}", "openDetails": "Open details", "layers": { "hunt_zone": "Hunts", "creature": "Creatures", "boss": "Bosses", "quest": "Quests", "location": "NPCs / Locations", "town": "Town" }, "town": "Town", "knownTowns": "Known towns and cities", "collapseSidebar": "Collapse map sidebar", "expandSidebar": "Expand map sidebar", "floor": "Floor {{floor}}", "floorUp": "Move one floor up", "floorDown": "Move one floor down", "pathfinding": "Show walkability layer", "reset": "Reset and recenter", "zoomIn": "Zoom in", "zoomOut": "Zoom out" },
            ...
            es: {
                translation: {
                    ...
                    "map": { "title": "Mapa", "searchLabel": "Buscar en el mapa", "searchPlaceholder": "Hunt, criatura, quest, NPC o ubicación", "loading": "Cargando datos locales del mapa…", "noResults": "Ningún resultado local coincide con la búsqueda.", "noBaseMap": "Todavía no hay un piso del mundo importado localmente.", "mapped": "Mapeado localmente", "knowledgeOnly": "Solo conocimiento", "noGeometry": "TibiaHub tiene conocimiento relacionado, pero no geometría fiable para esta entrada.", "coordinates": "Coordenadas: {{x}}, {{y}}, piso {{z}}", "openDetails": "Abrir detalles", "layers": { "hunt_zone": "Hunts", "creature": "Criaturas", "boss": "Bosses", "quest": "Quests", "location": "NPCs / Ubicaciones", "town": "Ciudad" }, "town": "Ciudad", "knownTowns": "Ciudades conocidas", "collapseSidebar": "Contraer panel del mapa", "expandSidebar": "Expandir panel del mapa", "floor": "Piso {{floor}}", "floorUp": "Subir un piso", "floorDown": "Bajar un piso", "pathfinding": "Mostrar capa transitable", "reset": "Restablecer y centrar", "zoomIn": "Acercar", "zoomOut": "Alejar" },
