        ...
        resources: {
            en: {
                translation: {
                    ...
                    "map": { "title": "Map", "workspace": "Tibia map workspace", "sidebar": "Map navigation and results", "filters": "Map categories", "recent": "Recent places", "searchResults": "Search results", "localNavigation": "Explore the local map", "searchLabel": "Search Map", "searchPlaceholder": "Hunt, creature, boss, item, quest, NPC or location", "loading": "Loading local map data…", "noResults": "No local results match this search.", "noBaseMap": "No locally imported world floor is available yet.", "mapped": "Mapped locally", "knowledgeOnly": "Knowledge only", "noGeometry": "TibiaHub has related knowledge, but no reliable geometry for this entry.", "locationNotMapped": "Location not mapped yet", "coordinates": "Coordinates: {{x}}, {{y}}, floor {{z}}", "openDetails": "Open details", "layers": { "hunt_zone": "Hunts", "creature": "Creatures", "boss": "Bosses", "item": "Items / loot", "quest": "Quests", "npc": "NPCs", "location": "Locations", "town": "Town" }, "town": "Town", "knownTowns": "Known towns and cities", "collapseSidebar": "Collapse map sidebar", "expandSidebar": "Expand map sidebar", "floor": "Floor {{floor}}", "internalFloor": "Tibia coordinate z={{floor}}", "mappedLocation": "Mapped location {{index}}", "floorUp": "Move one floor up", "floorDown": "Move one floor down", "pathfinding": "Show walkability layer", "reset": "Reset and recenter", "zoomIn": "Zoom in", "zoomOut": "Zoom out" },
            ...
            es: {
                translation: {
                    ...
                    "map": { "title": "Mapa", "workspace": "Espacio de trabajo del mapa de Tibia", "sidebar": "Navegación y resultados del mapa", "filters": "Categorías del mapa", "recent": "Lugares recientes", "searchResults": "Resultados de búsqueda", "localNavigation": "Explorar el mapa local", "searchLabel": "Buscar en el mapa", "searchPlaceholder": "Hunt, criatura, boss, objeto, quest, NPC o ubicación", "loading": "Cargando datos locales del mapa…", "noResults": "Ningún resultado local coincide con la búsqueda.", "noBaseMap": "Todavía no hay un piso del mundo importado localmente.", "mapped": "Mapeado localmente", "knowledgeOnly": "Solo conocimiento", "noGeometry": "TibiaHub tiene conocimiento relacionado, pero no geometría fiable para esta entrada.", "locationNotMapped": "Ubicación aún no mapeada", "coordinates": "Coordenadas: {{x}}, {{y}}, piso {{z}}", "openDetails": "Abrir detalles", "layers": { "hunt_zone": "Hunts", "creature": "Criaturas", "boss": "Bosses", "item": "Objetos / loot", "quest": "Quests", "npc": "NPCs", "location": "Ubicaciones", "town": "Ciudad" }, "town": "Ciudad", "knownTowns": "Ciudades conocidas", "collapseSidebar": "Contraer panel del mapa", "expandSidebar": "Expandir panel del mapa", "floor": "Piso {{floor}}", "internalFloor": "Coordenada Tibia z={{floor}}", "mappedLocation": "Ubicación mapeada {{index}}", "floorUp": "Subir un piso", "floorDown": "Bajar un piso", "pathfinding": "Mostrar capa transitable", "reset": "Restablecer y centrar", "zoomIn": "Acercar", "zoomOut": "Alejar" },
