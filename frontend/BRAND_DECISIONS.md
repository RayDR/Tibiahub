...
**Why:** TibiaHub contains multiple visual generations. Repeating legacy styling would preserve drift rather than remove it.
...
**Consequences:** Once normalized, new entity-driven features should reuse Cyclopedia patterns instead of inventing their own cards/search/detail composition.
...
**Consequences:** Documentation-only rules are considered incomplete when an inexpensive deterministic check can enforce them.
