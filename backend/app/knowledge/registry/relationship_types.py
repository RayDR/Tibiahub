...
INITIAL_RELATIONSHIP_TYPES = tuple(definition for pair in (
    ...
    _pair("starts_at", "start_of_route", ("route",), ("area", "town", "location")),
    _pair("ends_at", "end_of_route", ("route",), ("area", "town", "location")),
    _pair("passes_through", "traversed_by_route", ("route",), ("area", "town", "location")),
    _pair("appears_in", "has_creature", ("creature", "boss"), ("area", "location", "hunt_zone")),
    _pair("requires_hunt_quest", "required_for_hunt", ("hunt_zone",), ("quest",)),
    _pair("requires_access", "access_for_hunt", ("hunt_zone",), ("access",)),
