...
api_router.include_router(quest_progress.router)
...
api_router.include_router(localization_admin.router, prefix="/admin/knowledge", tags=["Knowledge Localization"])
...
api_router.include_router(quest_browser.router)
