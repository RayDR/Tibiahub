...
from app.api.v1 import assistant, creatures, hunt_zones, admin as admin_old, recommendations, items, item_browser, quests, quest_browser, knowledge_graph, npcs_locations, seo, spatial, tibia_map, hunt_analyzer, category_visuals
